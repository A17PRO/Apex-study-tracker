...
export default function TimerView({
    ...
    const offset = CIRC - (timeLeft / totalSecs) * CIRC;
    const pct = Math.round((1 - timeLeft / totalSecs) * 100);
            ...
            <div style={{
                ...
                <div style={{ position: "relative", width: 260, height: 260 }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: 14, opacity: 0.6 }}>
                            {active ? `${pct}% elapsed` : timeLeft === totalSecs ? MODES[modeIdx].label : "paused"}
                        </div>
                        {activeTasks.length > 0 && (
                ...
                <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                    ...
                    <button onClick={() => setActive(a => !a)} style={{
                        ...
                        {active ? "Pause" : timeLeft < totalSecs ? "Resume" : "Start Focus"}
                    </button>

                    <button onClick={() => setModeIdx(i => (i + 1) % MODES.length)} style={{
                        width: 40, height: 40, borderRadius: "50%", border: "none",
                        background: "#111827", color: "white", cursor: "pointer",
                    }}>▶</button>
                </div>
